...
public class DbConnection : IDbConnection
{
   ...
   private readonly IMongoDatabase _db; // database connection to mongo db
   private string _connectionId = "MongoDB"; // reference appsetting.json, key value
   ...
   /// <summary>
   /// client connection to dbName
   /// connection to collections, refer to collection
   ...
   {
      _config = config;
      // Mongo Client for connection string
